...
<?php
    if(isset($_GET['nik'])){
        $sql = "SELECT * FROM data_desa WHERE nik=$_SESSION[nik]";
...
if(isset($_POST['ubah'])){
	...
	nohp='$nohp',
	website='$website',
	email='$email' WHERE nik=$_SESSION[nik]";
		$query = mysqli_query($konek,$sql);
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=tampil_desa">';
	  }else{
		echo "<script language='javascript'>swal('Gagal...', 'Ubah Gagal', 'error');</script>" ;
		echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_desa">';
