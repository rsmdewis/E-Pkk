                                                ...
                                                <table id="add" class="display table table-striped table-hover" >
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $tampil = "SELECT * FROM data_user WHERE hak_akses= 'Pemohon'and 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <a href="?halaman=ubah_pemohon2&nik=<?php echo $username;?>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit User">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Data Desa</h4>
                            <a href="?halaman=tambah_desa" class="btn btn-primary btn-round ml-auto">
                                <i class="fa fa-plus"></i>
                                    Add Desa
                            </a>
                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table id="add" class="display table table-striped table-hover" >
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $no=1;
                                                            $tampil = "SELECT * FROM data_user WHERE hak_akses= 'Admin Desa' ";
                                                            $query = mysqli_query($konek,$tampil);
                                                            while($data=mysqli_fetch_array($query,MYSQLI_BOTH)){
                                                                $username = $data['nik'];
                                                                $nama = $data['nama'];
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $id_kec;?></td>
                                                            <td><?php echo $nohp;?></td>
                                                            <td><?php echo $password;?></td>
                                                            <td><?php echo $hak_akses;?></td>
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <a href="?halaman=ubah_desa2&nik=<?php echo $username;?>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Desa">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a href="?halaman=tampil_user&nik=<?php echo $username;?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Hapus Desa">
                                                                        <i class="fa fa-times"></i>
                                                                    </a>
                                                                </div>
                                                            </td>
